...
#
# Last edited: 8/18/23 - Chet Russell
...
# Main window class that contains the information of the entire window.
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap(os.getcwd() + "\\graphics\\icons8-close-window-16.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
    ...
    # Function to change the progress of progress bar 1
    def progress_fn_0(self, n):
        self.progressBar_0.setValue(n)

    # Function to change the progress of progress bar 2
    def progress_fn_1(self, n):
        self.progressBar_1.setValue(n)

    # Function to change the progress of progress bar 3
    def progress_fn_2(self, n):
        self.progressBar_2.setValue(n)

    # Function to print arbitrary information about a process
    def print_output(self, s):
        print(s)

    # Function to tell us when each thread completes
    def thread_complete(self):
        print("THREAD COMPLETE!")

    # Main page function. Runs both orthorectification and identification
    ...
    # Worker function to run main function in a thread
    ...
    # Orthorectification page function that runs only orthorectification
    ...
    # Worker function that runs orthorectification function in a thread
    ...
    # Identification page function that runs only identification
    ...
    # Worker function that runs identification in a thread
    ...
    # Merge page function that runs the merge orthos function
    ...
    # Worker function that runs merge in a thread
    ...
    # Function that selects an image directory for the 1st image dir select button
    ...
    # Function that selects a download directory for the 1st download dir select button
    ...
    # Function that selects an image directory for the 2nd image dir select button
    ...
    # Function that selects a download directory for the 2nd download dir select button
    ...
    # Function that selects a results directory for the 1st results dir select button
    ...
    # Function that selects a results directory for the 2nd results dir select button
    ...
    # Function that selects an ortho file for the 1st ortho file select button
    ...
    # Function that selects an ortho file for the 2nd ortho file select button
    ...
    # Function that selects an ortho file for the 3rd ortho file select button
    ...
    # The rest of these functions each provide the functionality of the "clear" buttons
    # Each button is listed in the order it is shown on the interface
