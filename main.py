...
def orthorec(imgdir: str, dwndir: str, quality: str, crop: int, kmz: bool, ft: str, exif: bool):
    ...
    try:
        ...
        task = n.create_task(imglist, skip_post_processing=True, options={'orthophoto-cutline': False, 'min-num-features': 20000, 'pc-quality': quality, 'texturing-data-term': 'gmi', 'verbose' : True, 'debug': True, 'time': True, 'crop': crop, 'auto-boundary': False, 'skip-3dmodel': True, 'cog': False, 'use-3dmesh': False, 'pc-tile' : True, 'orthophoto-kmz': kmz, 'use-exif' : exif, 'orthophoto-resolution': 1, 'no-gpu': False, 'ignore-gsd': False, 'fast-orthophoto': True, 'feature-type': ft}) 
        print(task.info())
